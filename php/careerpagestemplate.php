...
class CareerpagesTemplate {
	...
	public static function getCompany($companydata) {
		...
		global $prodiiUrl;
		$prodiiUrl = CareerpagesLibrary::getProdiiUrl();
		
		$gui = 	'';
		if (isset($companydata["basic"])) {
			$gui .= '
					'.self::getCompanyheaderGui($companydata).'
					'.self::getCompanybasicGui($companydata).'
					'.self::getCompanyskillsGui($companydata).'
					'.self::getCompanyindustryGui($companydata).'
					'.self::getCompanycountriesGui($companydata).'
					'.self::getCompanyteamsGui($companydata).'
					'.self::getCompanyfooterGui().'
					';
		}

		return $gui.self::getLoaderGui();
	}
	...
	public static function getTeam($teamdata) {
		...
		$gui =	'
				...
				'.self::getTeamheaderGui($teamdata).'
				'.self::getTeamBasicGui($teamdata).'
				'.self::getTeamcountriesGui($teamdata).'
				'.self::getTeameducationGui($teamdata).'
				'./*self::getTeamsubheaderGui()*/''.'
				'.self::getTeamskillsGui($teamdata).'
				'.self::getTeamindustriGui($teamdata).'
				'.self::getTeammembersGui($teamdata).'
				'.self::getTeamfooterGui().'
				';
	...
	public static function getProfile($profiledata) {
		...
		$gui = 	'
				...
				'.self::getProfileheaderGui($profiledata).'
				'.self::getProfileBasicGui($profiledata).'
				'.self::getProfileaboutGui($profiledata).'
				'.self::getProfileindustriGui($profiledata).'
				'./*self::getProfilesubheaderGui()*/''.'
				'.self::getProfileeducationGui($profiledata).'
				'.self::getProfilefooterGui().'
				';
